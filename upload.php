...
if(mysqli_num_rows($query) == 0) {
    ...
    $insert = mysqli_query($con, "INSERT INTO listingdata (email,nam, phone, title, descrip, city, stat, addy, bhk, price, purpose, sqft, advance, parking, floor, balcony, da, age, bathroom, secure, elevator, images, expired) VALUES ('$email', '$name', '$pn', '$title', '$descrip', '$city', '$state', '$address', '$bhk', '$price', '$purpose', '$sqft', '$advance', '$parking', '$floor', '$balcony', '$date', '$age', '$bathroom', '$secure', '$elevator', '$image_filenames_str', 'false');");
